...
Step 2
### Task.
The customer retention study requires creating a data showcase that should reflect the following information:
...
Thanks to showcase it is possible to find out, which categories of goods keep the clients better.

Scheme of the mart.f_customer_retention showcase:
