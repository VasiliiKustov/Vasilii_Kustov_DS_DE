...
@dag(
    ...
    tags=['sprint5', 'stg', 'dds', 'cdm', 'schema', 'ddl'],  # Теги, используются для фильтрации в интерфейсе Airflow.
    is_paused_upon_creation=True  # Остановлен/запущен при появлении. Сразу запущен.
)
def _001_init_schema_dag():
...
stg_init_schema_dag = _001_init_schema_dag()
